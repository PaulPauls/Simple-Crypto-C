 ...
 *
 * Process:
 * 	[1] Define key and plaintexts, declare ciphertexts
...
int main()
{
	...
	aes256_ecb_encrypt(plaintext1, sizeof(plaintext1), key, sizeof(key),
		ciphertext1, sizeof(ciphertext1));
	aes256_ecb_encrypt(plaintext2, sizeof(plaintext2), key, sizeof(key),
		ciphertext2, sizeof(ciphertext2));
	aes256_ecb_encrypt(plaintext3, sizeof(plaintext3), key, sizeof(key),
		ciphertext3, sizeof(ciphertext3));
	aes256_ecb_encrypt(plaintext4, sizeof(plaintext4), key, sizeof(key),
		ciphertext4, sizeof(ciphertext4));
	aes256_ecb_encrypt(plaintext5, sizeof(plaintext5), key, sizeof(key),
		ciphertext5, sizeof(ciphertext5));
